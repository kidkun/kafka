...
object TestUtils extends Logging {
  ...
  def createProducer[K, V](brokerList: String,
    ...
    producerProps.put(ProducerConfig.MAX_METADATA_FETCH_BLOCK_MS_CONFIG, maxBlockMs.toString)
  ...
  def makeLeaderForPartition(zkClient: KafkaZkClient,
    ...
    zkClient.setTopicPartitionStatesRaw(newLeaderIsrAndControllerEpochs, ZkVersion.NoVersion)
  }
